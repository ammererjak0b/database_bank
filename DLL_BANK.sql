...
CREATE TABLE BANK_STATEMENT
    (
     ...
     withdrawel_sum              NUMBER (15,2)   NOT NULL,
     withdrawel_count            INTEGER         NOT NULL,
...
CREATE TABLE PAYMENT_TRANSACTION
    (
     transaction_id INTEGER             NOT NULL,
     external_iban  VARCHAR2 (34 CHAR)  NOT NULL,
     external_bic   CHAR (11 CHAR)      NOT NULL
    );
...
-- Trigger: Bei Kontoanlage automatisch ersten leeren Kontoauszug erstellen
-- Stellt sicher dass statement_id auf TRANSACTIONS immer NOT NULL sein kann
